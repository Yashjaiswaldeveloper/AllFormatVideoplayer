...
import com.fftwo.ffftwo.gametwo.CountryModal;
import com.fftwo.ffftwo.gametwo.Country_Code;
import com.fftwo.ffftwo.gametwo.R;
import com.fftwo.ffftwo.gametwo.RegionChooserDialog;
import com.fftwo.ffftwo.gametwo.SharePreferencess;
import com.fftwo.ffftwo.gametwo.Utilss;
        ...
        UnifiedSDK.getVpnState(new Callback<VPNState>(){
            ...
            public void success(@NonNull VPNState vpnState) {
                if (vpnState == VPNState.CONNECTED) {
                    Intent intent = new Intent(VPNActivity.this, StartActivity.class);
