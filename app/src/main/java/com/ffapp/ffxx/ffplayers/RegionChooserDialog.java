...
public class RegionChooserDialog extends DialogFragment implements com.fftwo.ffftwo.gametwo.CountryAdapter.selecTionCountry, View.OnClickListener {
    ...
    View mainView;
    com.fftwo.ffftwo.gametwo.CountryAdapter countryAdapter;
    ...
    private void loadServer() {
        ...
        UnifiedSDK.getInstance().getBackend().countries(new Callback<AvailableCountries>() {
            ...
            public void success(@NonNull final AvailableCountries countries) {
                ...
                com.fftwo.ffftwo.gametwo.Utilss.list = countries.getCountries();
                for (Country country : com.fftwo.ffftwo.gametwo.Utilss.list) {
                    for (com.fftwo.ffftwo.gametwo.Country_Code counteyModal : com.fftwo.ffftwo.gametwo.Utilss.list_Country) {
                        if (country.getCountry().equalsIgnoreCase(counteyModal.getCode())) {
                            com.fftwo.ffftwo.gametwo.Country_Code newModal = new com.fftwo.ffftwo.gametwo.Country_Code();
                ...
                for (com.fftwo.ffftwo.gametwo.Country_Code aa : list) {
                ...
                countryAdapter = new com.fftwo.ffftwo.gametwo.CountryAdapter(context, list, 1);
