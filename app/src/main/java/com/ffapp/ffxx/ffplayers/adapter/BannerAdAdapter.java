...
public class BannerAdAdapter extends RecyclerViewAdapterWrapper {
    ...
    private void onBindAdViewHolder(final RecyclerView.ViewHolder holder) {
        ...
        if (mParam.forceReloadAdOnBind || !adHolder.loaded) {
            ...
            //AppManage.getInstance(context).showFull_BANNER((ViewGroup) adHolder.native_container, ADMOB_B1, FACEBOOK_B1,context);
    ...
    public static class Builder {
        ...
        public BannerAdAdapter build() {
            return new BannerAdAdapter(mParam);
        }
